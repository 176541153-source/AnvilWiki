...
**懒人通道:让 AI 做一次逐项体检**。支持技能的 AI 助手里输入 `/anvil-adsense-audit`,它会按 Google 官方政策逐项检查(内容原创度、隐私页有没有提广告 cookie、过期码、空分类……模板已解决的项自动给证据),输出一张 Pass/Fail/Unknown 表格。两条纪律:**口头「应该没问题」不算过**——每项要么有证据,要么写明缺什么;**有 Blocker 时别交申请**,修完再交,被拒记录会跟着账户走。
