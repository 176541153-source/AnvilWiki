...
> **当前版本:v2.4.0**(2026-08-29 发布)。发版历史与最新版本见 [Releases](https://github.com/PNGTRID/AnvilWiki/releases)。
...
| SEO 进阶 | v1.19 | 对齐 2026 搜索新格局 | 学习手册第 11 章「SEO 进阶」(排名 + AI 引用)、`docs/seo.md` 收录 2026 Google 官方更新记录、封面图升级为图片搜索入口、本路线图 |
